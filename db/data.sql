...
INSERT INTO utilisateur('login','numSS','nom','prenom','dateNaissance','mdp') values('maximel',190023854401932,'Lefebvre','Maxime','1990-02-09','roucarnage');
INSERT INTO utilisateur('login','numSS','nom','prenom','dateNaissance','mdp') values('francoisg',190023854401933,'Guillepain','François','1988-08-15','pakhorabane');
INSERT INTO utilisateur('login','numSS','nom','prenom','dateNaissance','mdp') values('nathand',290023854401932,'Ducrey','Nathan','1990-06-20','getsubyakuya666ofdeathkillinginnocentmonkeys');

/* insertion des contacts */
INSERT INTO contact('identifiant','numSS','nom','prenom','dateNaissance') values('billt',190023854401932,'Tremendous','Bill','1978-04-25');
INSERT INTO contact('identifiant','numSS','nom','prenom','dateNaissance') values('hubertb',190023854401932,'Bertier','Hubert','1982-12-01');
INSERT INTO contact('identifiant','numSS','nom','prenom','dateNaissance') values('ichigok',190023854401932,'Kurosaki','Ichigo','1982-12-01');
INSERT INTO contact('identifiant','numSS','nom','prenom','dateNaissance') values('narutou',190023854401932,'Uzumaki','Naruto','1982-12-01');
INSERT INTO contact('identifiant','numSS','nom','prenom','dateNaissance') values('tryndalol',190023854401932,'LoL','Tryndamère','1982-12-01');
INSERT INTO contact('identifiant','numSS','nom','prenom','dateNaissance') values('garenlol',190023854401932,'LoL','Garen','1982-12-01');
INSERT INTO contact('identifiant','numSS','nom','prenom','dateNaissance') values('stephanec',190023854401932,'Crozat','Stéphane','1922-12-01');
